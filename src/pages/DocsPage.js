...
const DocsPage = () => {
  return (
    <div className="border-black dark:bg-slate-500 transition-all">
      <HeaderNav></HeaderNav>
      <div className=" sm:px-3 sm:pb-5 xl:px-5 grid xl:grid-cols-4 sm:grid-cols-1 lg:grid-cols-2 gap-5">
        <iframe
        ...
        ></iframe>
        <iframe
          src="https://docs.google.com/presentation/d/e/2PACX-1vRtCLqnROtMuJs5EVWDSGmAJQ-GjATXYhpZvBgvG6chmx7OYIMStiCYthBYTmY1RA/embed?start=false&loop=false&delayms=3000"
          frameborder="0"
          className="w-[100%] h-[350px] rounded-xl"
          allowfullscreen="true"
          mozallowfullscreen="true"
